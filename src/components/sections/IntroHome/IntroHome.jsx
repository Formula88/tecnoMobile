          ...
          <div className={styles.box}>
            <div className={styles.right}>
              <div className={styles.text}>
                <span className={`alertText ${styles.alert}`}>NEXT-GEN TECHNOLOGY</span>
              ...
              <div className={styles.btns}>
                <Link to="" className="btnPrimary">مشاهده محصولات</Link>
                <Link to="" className="btnOutline">دریافت کانفیگ</Link>
              </div>
            </div>
